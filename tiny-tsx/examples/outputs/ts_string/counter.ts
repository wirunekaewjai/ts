// AUTO GENERATED
export const counter = (count: number) => `<div class="p-2 flex flex-row items-center" hx-target="this" hx-swap="outerHTML"><button class="w-8 h-8 bg-red-600 text-white rounded-md shadow-md" hx-get="/@counter" hx-vals="{&quot;count&quot;&quot;count - 1&quot;count - 1}">+</button></div>`;
